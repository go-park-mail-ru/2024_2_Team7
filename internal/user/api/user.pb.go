...
var file_user_proto_rawDesc = []byte{
	...
	0x45, 0x6d, 0x70, 0x74, 0x79, 0x32, 0xf3, 0x01, 0x0a, 0x0b, 0x55, 0x73, 0x65, 0x72, 0x53, 0x65,
...
var file_user_proto_depIdxs = []int32{
	...
	5, // 6: user.UserService.Subscribe:output_type -> user.Empty
	5, // 7: user.UserService.Unsubscribe:output_type -> user.Empty
	2, // 8: user.UserService.GetSubscriptions:output_type -> user.GetSubscriptionsResponse
